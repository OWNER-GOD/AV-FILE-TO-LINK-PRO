...
CHANNEL = environ.get('CHANNEL', 'https://t.me/ownergodupdate')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/ownergodupdate')  # Support group
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://desembermethod_db_user:v4ADkgywaYxrZW1y@cluster0.ghvofhb.mongodb.net/?appName=Cluster0")  # MongoDB connection URI
